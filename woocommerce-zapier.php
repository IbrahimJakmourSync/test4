...
Description: Integrates WooCommerce with <a href="https://zapier.com/" target="_blank">Zapier</a>. Send WooCommerce data to 2000+ cloud services. Create or update WooCommerce data from 2000+ cloud services via Zaps.
Version: 2.0.4
Author: OM4
...
/*
Copyright 2013-2020 OM4 (email: plugins@om4.io    web: https://om4.io/)
...
define( 'WC_ZAPIER_MINIMUM_SUPPORTED_PHP_VERSION', '5.6.20' );
...
function wc_zapier_incompatible_php_version_admin_notice() {
	...
	$message = __( 'WooCommerce Zapier is disabled because it is only compatible with PHP version %1$s or later. Please contact your web host to upgrade from PHP version %2$s to a newer version. We recommend using PHP 7.3 or greater.', 'woocommerce-zapier' );
